...
import { baseURL, fetchNonCarbonatedAnalyses } from "../../api"
...
const columns = [
    ...
    },
    {
        flex: 1,
        minWidth: 80,
        field: 'temperature_after_filling',
        headerName: 'Temperature After Filling'
    },
    {
        flex: 1,
        minWidth: 80,
        field: 'temperature_before_tilter',
        headerName: 'Temperature Before Tilter'
    },
    {
        flex: 1,
        minWidth: 80,
        field: 'temperature_after_cooling',
        headerName: 'Temperature After Cooling'
    },
    {
        flex: 1,
        minWidth: 80,
        field: 'pressure_after_filling',
        headerName: 'Pressure After Filling'
    },
    {
        flex: 1,
        minWidth: 80,
        field: 'pressure_after_cooling',
        headerName: 'Pressure After Cooling'
    },
    {
        flex: 1,
        minWidth: 80,
        field: 'brix_after_filling',
        headerName: 'Brix After Filling'
    },
    {
        flex: 1,
        minWidth: 80,
        field: 'brix_after_cooling',
        headerName: 'Brix After Cooling'
    },
    {
        flex: 1,
        minWidth: 80,
...
const NonCarbonatedDrinks = () => {

    const [params, setParams] = useSearchParams()

    const { data, meta, loading } = useAnalyses(params, fetchNonCarbonatedAnalyses)
...
export default NonCarbonatedDrinks